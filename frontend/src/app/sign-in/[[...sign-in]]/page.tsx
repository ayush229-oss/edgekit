/**
 * Sign-in page — uses Clerk's drop-in component.
 *
 * Brand-matched theme: cream background, money-green accents.
 * The catch-all dynamic segment `[[...sign-in]]` lets Clerk render its own
 * sub-routes (OAuth callback, magic link verify, etc.) under this path.
 */
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-paper px-6 py-12">
      <div className="mb-8 text-center">
        ...
        <p className="text-[13px] text-muted mt-1.5">Sign in to keep building.</p>
      </div>
      ...
      <p className="text-[11px] text-muted mt-6 text-center max-w-md">
        Edgekit stores your strategies, custom nodes, and backtests so you can
        access them on any device. API keys are encrypted at rest.
      </p>
    </div>
  );
}
